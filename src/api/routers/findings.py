...
@router.post("/{finding_id}/snooze", response_model=SnoozeResponse)
def snooze_finding(finding_id: str, request: SnoozeRequest, db: Session = Depends(get_db)):
...
@router.post("/{finding_id}/unsnooze")
def unsnooze_finding(finding_id: str, db: Session = Depends(get_db)):
...
@router.post("/calculate-risk-scores", response_model=CalculateRiskScoresResponse)
