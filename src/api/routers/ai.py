...
@router.post("/merge-duplicates/{group_id}")
...
@router.post("/learn-false-positives", response_model=LearnFPResponse)
...
@router.post("/apply-fp-suggestions")
